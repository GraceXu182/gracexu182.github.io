...
- **[DynG2G: An Efficient Stochastic Graph Embedding Method for Temporal Graphs](https://arxiv.org/pdf/2109.13441.pdf)**
    ...
    **Mengjia Xu**, Apoorva Vikram Singh, George Em Karniadakis 
    ...
    _Under revision, submitted to TNNLS, 2021._ [[Paper](Papers/2021_DynG2G.pdf)], [[Bibtex]()]
...
> - 2022.2.2, presented “Graph Embedding with Uncertainty Quantification for Diverse Applications” for the "Data Science Seminar" of the [Institue For Data Science](https://datascience.njit.edu/), Ying Wu College of Computing at [New Jersey Institute of Technology](https://www.njit.edu/), hosted by [Prof. David Bader](https://davidbader.net/) and [Prof. Guiling Wanng](https://people.njit.edu/faculty/gwang).
